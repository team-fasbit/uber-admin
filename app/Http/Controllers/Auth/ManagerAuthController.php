...
class ManagerAuthController extends Controller
{
    ...
    */
    ...
    protected $registerView = 'manager.auth.register';
    ...
    {
        $this->middleware('guestmanager', ['except' => 'logout']);
    }
    ...
    protected function validator(array $data)
    {
        return Validator::make($data, [
            ...
            'email' => 'required|email|max:255|unique:call_center_managers',
    ...
    {
        return CallCenterManager::create([
            'name' => $data['name'],
            'email' => $data['email'],
