...
class CorporatePasswordController extends Controller
{
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    protected $linkRequestView = 'corporate.auth.passwords.email';
    ...
    protected $resetView = 'corporate.auth.passwords.reset';
