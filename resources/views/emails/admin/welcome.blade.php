                            ...
                            <table align="center" bgcolor="#FFFFFF" style="border-radius:4px; box-shadow: 0px 3px 0px #d4d2d2;" width="100%" border="0" cellspacing="0" cellpadding="0">
                             ...
                             <!--     <tr bgcolor="#f8f8f8">
                               ...
                               <!--  <tr>
                                ...
                                <tr>
                                    <td data-bgcolor="Content BG" align="center" bgcolor="#f8f8f8" style="border-bottom: 2px solid #f5f5f5;">
                                           ...
                                           <!--  <tr>
                                            ...
                                            <tr>
                                                <td data-link-style="text-decoration:none; color:#3cb2d0;" data-link-color="Content Link" data-color="Main Text" data-size="Main Text" mc:edit="content" align="left" style="font-family: 'Open Sans', Arial, sans-serif; font-size:14px; color:#7f8c8d; line-height:30px;">
                                                    Hi, {{$email_data['first_name']}} {{$email_data['last_name']}}<br/>
                                                    <p> Welcome to {{Setting::get('site_name')}}. You've just joined a community of millions who have discovered how quick and easy it is to use.
                                                    </p>
                                                    <p>
                                                         <b>
                                                            Your Name is : {{$email_data['first_name']}} {{$email_data['last_name']}}</b>
                                                         <br/>
                                                         <b>Your Password is : {{$email_data['password']}}</b>
                                                    </p>
                                                  <p>
