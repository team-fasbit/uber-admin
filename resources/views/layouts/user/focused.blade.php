 ...
 <div class="col-md-6 col-md-offset-3">
    ...
    <div class="login-box">
        <div class="login-logo">
             <a href="{{route('corporate.login')}}"><b> <img class="adm-log-logo" style="width:50%;height:auto" src="@if(Setting::get('site_logo')) {{Setting::get('site_logo')}} @else {{asset('logo.png')}} @endif" /></b></a>
        </div>
