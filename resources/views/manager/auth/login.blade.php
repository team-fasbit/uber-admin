...
@section('content')
    ...
    <div class="login-box-body" style="height:275px">
        ...
        <form class="form-layout" role="form" method="POST" action="{{ url('/manager/login') }}">
            {{ csrf_field() }}
            ...
            <!--<div class="form-group">
                    <a style="margin-left:100px" class="btn btn-link" href="{{ url('/manager/password/reset') }}">Reset Password</a>
            </div>-->
