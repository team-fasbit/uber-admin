...
@section('title', tr('view_corporate'))

@section('content-header', tr('view_corporate'))

@section('breadcrumb')
    <li><a href="{{route('admin.dashboard')}}"><i class="fa fa-dashboard"></i>{{tr('home')}}</a></li>
    <li><a href="{{route('admin.corporates')}}"><i class="fa fa-user"></i> {{tr('corporates')}}</a></li>
    <li class="active"><i class="fa fa-user"></i> {{tr('view_corporate')}}</li>
@endsection
