...
@section('content')
    ...
    <div class="login-box-body" style="height:275px">
        ...
        <form class="form-layout" role="form" method="POST" action="{{ url('/provider/login') }}">
            {{ csrf_field() }}
            ...
            <div class="form-inputs">
                <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                    <input type="email" class="form-control input-lg" name="email" placeholder="Email" value="info@smart-car.tech">
                ...
                <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                    ...
                    <input type="password" class="form-control input-lg" name="password" placeholder="Password" value="12345">
